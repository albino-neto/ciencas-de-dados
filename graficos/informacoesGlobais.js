...
async function vizualizarInformacoesGlobais() {
    ...
    paragrafo.innerHTML = `Você sabia que o mundo tem <span>${pessoasNoMundo} bilhões</span> de pessoas e que aproximadamente <span>${pessoasJogando} bilhões</span> estão jogando em algum esporte e passam em média <span>${horas} horas Jogando.<br>Isso significa que aproximadamente <span>${porcentagemJogando}%</span> de pessoas que estão jogando.`
